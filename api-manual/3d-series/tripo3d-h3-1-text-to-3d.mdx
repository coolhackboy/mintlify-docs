...
Create textured 3D objects from text with Tripo3D H3.1, with control over mesh detail, surface quality, and PBR materials.

## Available Models

- **tripo3d/h3.1/text-to-3d** - Generate a 3D model from a text prompt.
