...
Create short video scenes with Kling 1.6 Pro, using text direction and negative prompts to shape the action and appearance.

## Available Models

- **kwaivgi/kling-video/v1.6/pro/text-to-video** - Generate video scenes from text prompts.
