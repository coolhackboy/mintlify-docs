...
description: "Google Veo 3.1 Lite text to video model with fixed 8-second output"
icon: "video"
openapi: "/api-manual/video-series/veo3-1-lite-text-to-video.json POST /api/generate/submit"
---
