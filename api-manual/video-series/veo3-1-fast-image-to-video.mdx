...
description: "Google Veo 3.1 Fast image to video model with fixed 8-second output"
icon: "video"
openapi: "/api-manual/video-series/veo3-1-fast-image-to-video.json POST /api/generate/submit"
---
