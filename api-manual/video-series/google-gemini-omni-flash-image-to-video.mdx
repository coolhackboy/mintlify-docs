...
Animate a still image with Gemini Omni Flash, using text direction to develop a short video scene at up to 4K.

## Available Models

- **google/gemini-omni-flash/image-to-video** - Generate video from image input.
