...
description: "Kling 2.1 Standard image-to-video with a required start frame. End frames are not supported."
icon: "video"
...
Kling 2.1 Standard image-to-video with a required start frame. End frames are not supported.
...
- `end_image_url` is not supported by Standard; use the Pro endpoint for an optional ending frame.
