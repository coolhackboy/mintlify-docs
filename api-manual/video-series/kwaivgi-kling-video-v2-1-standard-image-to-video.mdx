...
description: "Kling 2.1 Standard image-to-video with a required start frame."
icon: "video"
...
Kling 2.1 Standard image-to-video with a required start frame.
...
- For an optional ending frame, use the [Pro endpoint](/api-manual/video-series/kwaivgi-kling-video-v2-1-pro-image-to-video).
