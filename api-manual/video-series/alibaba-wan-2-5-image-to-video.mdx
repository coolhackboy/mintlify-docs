...
Animate a reference image into a five-second clip with Wan 2.5, with audio input and video output up to 1080p.

## Available Models

- **alibaba/wan-2.5/image-to-video** - Generate video from image input.
