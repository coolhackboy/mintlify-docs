...
Animate image references with Kling O3 Standard, with support for multiple shots, individual shot prompts, and optional sound.

## Available Models

- **kwaivgi/kling-video-o3-std/image-to-video** - Generate video from image input.
...
- `sound`: Required. Control audio generation. Use `true` or `false`.
