...
description: "Google Veo 3.1 Fast reference to video model with fixed 8-second output"
icon: "video"
openapi: "/api-manual/video-series/veo3-1-fast-reference-to-video.json POST /api/generate/submit"
---
...
- The model ID fixes generation to `reference-to-video`.
