---
title: "VEO 3.1 Legacy IDs"
description: "Compatibility reference for the legacy veo3.1-fast and veo3.1-quality model IDs"
...
<Warning>
This page documents legacy model IDs kept for compatibility. New integrations should use the model-specific VEO 3.1 public model pages in the navigation.
</Warning>
