...
Create video scenes from text with Veo 3.1 Fast, with optional sound and landscape or portrait output up to 4K.

## Available Models

- **google/veo3.1-fast/text-to-video** - Generate video scenes from text prompts.
