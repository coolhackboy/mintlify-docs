...
description: "Seedance 2.0 Fast reference to video model with multimodal generation and optional audio"
icon: "video"
openapi: "/api-manual/video-series/seedance-2-0-fast-reference-to-video.json POST /api/generate/submit"
---
