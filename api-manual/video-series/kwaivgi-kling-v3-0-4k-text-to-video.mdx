...
Direct video sequences with Kling 3.0 4K, using individual shot prompts, shot timing, and optional sound to shape a scene.

## Available Models

- **kwaivgi/kling-v3.0-4k/text-to-video** - Generate video scenes from text prompts.
