...
description: "Seedance 2.0 image to video model with multimodal generation and optional audio"
icon: "video"
openapi: "/api-manual/video-series/seedance-2-0-image-to-video.json POST /api/generate/submit"
---
...
- **seedance-2.0/image-to-video** - Seedance 2.0 image to video generation
