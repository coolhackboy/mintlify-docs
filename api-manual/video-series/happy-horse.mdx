...
Send a single-item `image_urls` array. The image is used as the first frame. A nonblank `prompt` of at most 5,000 characters is required.
...
- **model**: `happy-horse`
- **input.prompt**: Required for text-to-video, image-to-video, and reference-to-video (maximum 5,000 characters). Required for video-edit (maximum 2,500 characters).
...
- [alibaba/happyhorse-1.0/text-to-video](/api-manual/video-series/alibaba-happyhorse-1-0-text-to-video)
- [alibaba/happyhorse-1.0/image-to-video](/api-manual/video-series/alibaba-happyhorse-1-0-image-to-video)
- [alibaba/happyhorse-1.0/reference-to-video](/api-manual/video-series/alibaba-happyhorse-1-0-reference-to-video)
- [alibaba/happyhorse-1.0/video-edit](/api-manual/video-series/alibaba-happyhorse-1-0-video-edit)
{/* poyo-20260910:end */}
