...
Direct video sequences with Kling 3.0 Pro, using individual shot prompts, shot timing, and optional sound to shape a scene.

## Available Models

- **kwaivgi/kling-v3.0-pro/text-to-video** - Generate video scenes from text prompts.
