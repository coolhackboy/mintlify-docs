...
description: "Seedance 2.0 text to video model with multimodal generation and optional audio"
icon: "video"
openapi: "/api-manual/video-series/seedance-2-0-text-to-video.json POST /api/generate/submit"
---
...
- **seedance-2.0/text-to-video** - Seedance 2.0 text to video generation
