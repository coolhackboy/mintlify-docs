...
Animate image references with Kling 3.0 Pro, with support for multiple shots, individual shot prompts, and optional sound.

## Available Models

- **kwaivgi/kling-v3.0-pro/image-to-video** - Generate video from image input.
