...
Animate reference images with Kling 1.6 Pro, using text direction and negative prompts to shape the scene and motion.

## Available Models

- **kwaivgi/kling-video/v1.6/pro/image-to-video** - Generate video from image input.
...
- `start_image_url`: Optional. Provide the starting frame URL. Use a publicly accessible HTTP(S) URL.
