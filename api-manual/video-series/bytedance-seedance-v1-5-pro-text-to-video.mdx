...
Create video scenes with Seedance 1.5 Pro, with optional generated audio and a fixed-camera setting for controlled compositions.

## Available Models

- **bytedance/seedance-v1.5-pro/text-to-video** - Generate video scenes from text prompts.
