...
Turn written scene concepts into short videos with Gemini Omni 1.1 Flash, with landscape or portrait framing and output up to 4K.

## Available Models

- **google/gemini-omni-1.1-flash/text-to-video** - Generate video scenes from text prompts.
